...
public class Max {
	...
	public int max(int a, int b) {
		...
		Memory.getMemory().write(dAddr, 96, data);

		Transformer t = new Transformer();
		String instrA = "11000111" + "10000011" + zero + t.intToBinary(String.valueOf(a));
		String instrB = "11000111" + "10000011" + "00000000000000000000000000100000" + t.intToBinary(String.valueOf(b));
